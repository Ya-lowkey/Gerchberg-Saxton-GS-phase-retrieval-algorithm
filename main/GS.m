...
I1=double(imread('peppers.bmp','bmp'));%ÊäÈëÍ¼Ïñ1£¨²Î¿¼Í¼Ïñ£©
I1=I1(:,:,1);
[row,col]=size(I1);
figure(1)
imshow(I1,[]);%
...
I_start=ifft2(ifftshift(I_target));% Back diffraction
...
imshow(uint8(II.*255))
imwrite(uint8(II.*255),'result_gs.bmp','bmp');
